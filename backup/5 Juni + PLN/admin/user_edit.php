            ...
            <form action="user_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="regional" placeholder="Kosong Jika tidak ingin di ganti" value="<?php echo $d['regional_kode'] ?>">
                  <input type="hidden" class="form-control" name="id" value="<?php echo $d['user_id'] ?>" required="required">
                </div>

                <div class="form-group">
                  <label>KPRK</label>
                  <input type="text" class="form-control" name="KPRK" placeholder="Kosong Jika tidak ingin di ganti" value="<?php echo $d['kodekantor'] ?>">
                  <input type="hidden" class="form-control" name="id" value="<?php echo $d['user_id'] ?>" required="required">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="level" required="required">
                    ...
                    <option <?php if($d['user_level'] == "regional"){echo "selected='selected'";} ?> value="regional"> Regional </option>
                    <option <?php if($d['user_level'] == "kprk"){echo "selected='selected'";} ?> value="KPRK"> KPRK </option>
                  </select>
                </div>
