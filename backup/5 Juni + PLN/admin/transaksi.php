              ...
              <div style="padding: 10px">
                  <div id="exTab1"> 
                    <ul  class="nav nav-pills">
                      ...
                      <li><a href="#4a" data-toggle="tab">REKONSILIASI</a>
                      </li>
                    </ul>
                    ...
                    <div class="tab-content clearfix">
                      <div class="tab-pane active" id="1a">
                        ...
                        <a href="laporan_printdetail.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
                      ...
                      <!---------------------------------------------------------------------------------------------------------->
                       <div class="tab-pane" id="2a">
                        ...
                        <a href="laporan_printuser.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
                      ...
                      <div class="tab-pane" id="3a">
                        ...
                        <a href="laporan_printkantor.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
