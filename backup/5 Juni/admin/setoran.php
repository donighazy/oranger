...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      LAPORAN
      <small>Data Pengawasan Setoran</small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Laporan Data Setoran</h3>
          </div>
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_setoranpdf.php?transaksi_tanggal=<?php echo $tgl_trx ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
              <a href="laporan_printsetoran.php?transaksi_tanggal=<?php echo $tgl_trx ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
