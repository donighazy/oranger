...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Pengguna
      <small>Detail Data Pengguna</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <form action="approval_update.php" method="post" enctype="multipart/form-data">
              <?php 
              $id = $_GET['id'];              
              $data = mysqli_query($koneksi, "select * from approval where pegawai_id='$id'");
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>IMEI</label>
                  <input type="text" class="form-control" name="IMEI" value="<?php echo $d['IMEI'] ?>" required readonly="required">
                </div>
