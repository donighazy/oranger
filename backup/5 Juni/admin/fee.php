...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      LAPORAN
      <small>Data Distribusi Fee</small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
            ...
            <form method="get" action="">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <br/>
                    <input type="submit" value="CEK DITRIBUSI FEE" class="btn btn-sm btn-primary btn-block">
                  </div>
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Laporan Data Fee</h3>
          </div>
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_printmanifest.php?transaksi_tanggal=<?php echo $tgl_trx ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
